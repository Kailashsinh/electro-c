  ...
  const plans = [
    {
      ...
      text: 'text-amber-900',
      icon: Shield,
      features: ['No Priority Status', 'Access Nearest Technicians', 'Unlimited Service Requests', 'Visiting Charges Apply'],
      highlight: false,
    },
    {
      id: 'premium',
      ...
      text: 'text-white',
      icon: Star,
      features: ['Priority over Gold Requests', 'Wider Technician Broadcast', '2 Free Technician Visits/Year', 'Unlimited Service Requests'],
      highlight: true,
      badge: 'MOST POPULAR'
    },
    {
      ...
      text: 'text-white',
      icon: Crown,
      features: ['Highest Priority over Gold & Premium', 'Broadest Technician Broadcast (Fastest)', '1 Free Visit Charge after every 2 Visits', 'Unlimited Service Requests'],
      highlight: false,
      cosmic: true,
    },
  ];
